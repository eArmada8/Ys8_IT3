...
The script has basic texture support for IT3 files with MAT6 blocks (Ys VIII/IX).  Place all the textures required in a 'textures' folder in the same folder as the .gltf file, in .png format.
